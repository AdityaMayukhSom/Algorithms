public class Trio<U, V, W> 
{
    ...
    {
        return String.format("Trio{first=%s, second=%s, third=%s}", this._first, this._second, this._third);
    }
    ...
    public boolean equals(Object obj) 
    {
        ...
        Trio<?, ?, ?> trio = (Trio<?, ?, ?>) obj;
        return this._first.equals(trio._first) && this._second.equals(trio._second) && this._third.equals(trio._third);
    }
